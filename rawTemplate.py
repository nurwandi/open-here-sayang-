...
from geopy.distance import geodesic as greatest_distance 
...
# ----------------------------------------------------------------------------------
    def distance(self, other_city: City) -> int:
        ...
        """
        #TODO
        return(round(greatest_distance(self.coordinates,other_city.coordinates).km))
...
def get_city_by_id(city_id: int) -> City | None:
    ...
    """
    #TODO
    # for city_list in name_to_cities.values():
...
def get_cities_by_name(city_name: str) -> list[City]:
    ...
    """
    #TODO
    # return City.name_to_cities.get(city_name, None)
